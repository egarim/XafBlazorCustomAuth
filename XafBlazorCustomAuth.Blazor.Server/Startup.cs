...
namespace XafBlazorCustomAuth.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<XafBlazorCustomAuthBlazorApplication>(Configuration);
            ...
            }).AddExternalAuthentication<HttpContextPrincipalProvider>().AddAuthenticationProvider<AuthenticationStandardProviderOptions, CustomAuthenticationProvider>(options =>
            {
