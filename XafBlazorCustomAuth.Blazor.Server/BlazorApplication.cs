...
using XafBlazorCustomAuth.Blazor.Server.Services;

namespace XafBlazorCustomAuth.Blazor.Server {
    public partial class XafBlazorCustomAuthBlazorApplication : BlazorApplication {
        public XafBlazorCustomAuthBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafBlazorCustomAuthBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
